...
using System.Web;
using JieYiGuang.Core.ComponentModel;
using JieYiGuang.Core.Domain.Shipping;
...
namespace JieYiGuang.Core
{
    ...
    public partial class CommonHelper
    {
        ...
        {
            //little hack here
            //always set culture to 'zh-CN' (Kendo UI has a bug related to editing decimal values in other cultures). Like currently it's done for admin area in Global.asax.cs
