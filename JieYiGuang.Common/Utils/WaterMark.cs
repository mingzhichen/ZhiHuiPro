...
namespace JieYiGuang.Common.Helper
{
    ...
    public class WaterMark1
    {
        ...
        public WaterMark1(string text, string fontFamily, bool bold, Color color, int markX, int markY)
        {
            this._imgMark = false;
            this._textMark = true;
            this._text = text;
        ...
        /// <param name="markX">标记位置横坐标</param>
        /// <param name="markY">标记位置纵坐标</param>
        public WaterMark1(string imagePath, float tranparence, int markX, int markY)
        {
