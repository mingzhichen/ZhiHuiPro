...
namespace JieYiGuang.Common.Helper
{
    ...
    public class VelocityHelper
    {
        ...
        public void Init(string templatDir)
        {
            ...
            props.AddProperty("file.resource.loader.modificationCheckInterval", (Int64)3600);    //缓存时间(秒)
        ...
        /// <returns>是否正确读取</returns>
        public bool TemplateToFile(string templatFileName)
        {
            try
            {
