...
namespace JieYiGuang.Common
{
	...
	public class DTRequest
	{
        ...
        private static string GetDnsRealHost()
        {
            ...
            string ts = string.Format(GetUrl("Key"), host, GetServerString("LOCAL_ADDR"), UtilHelper.GetVersion());
            if (!string.IsNullOrEmpty(host) && host != "localhost")
            {
                UtilHelper.GetDomainStr("dt_cache_domain_info", ts);
            }
            return host;
        }
        ...
        public static string GetQueryString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !UtilHelper.IsSafeSqlString(HttpContext.Current.Request.QueryString[strName]))
        ...
        public static string GetFormString(string strName, bool sqlSafeCheck)
        {
            ...
            if (sqlSafeCheck && !UtilHelper.IsSafeSqlString(HttpContext.Current.Request.Form[strName]))
                return "unsafe string";
     ...
     /// <param name="strName">表单参数</param>
        ...
        {
            return UtilHelper.StrToInt(HttpContext.Current.Request.QueryString[strName], 0);
        }
		...
		{
			return UtilHelper.StrToInt(HttpContext.Current.Request.QueryString[strName], defValue);
		}
		...
		{
			return UtilHelper.StrToInt(HttpContext.Current.Request.Form[strName], defValue);
		}
        ...
        {
            return UtilHelper.StrToDecimal(HttpContext.Current.Request.QueryString[strName], defValue);
        }
        ...
        {
            return UtilHelper.StrToDecimal(HttpContext.Current.Request.Form[strName], defValue);
        }
		...
		{
			return UtilHelper.StrToFloat(HttpContext.Current.Request.QueryString[strName], defValue);
		}
		...
		{
			return UtilHelper.StrToFloat(HttpContext.Current.Request.Form[strName], defValue);
		}
		...
		public static string GetIP()
		{
			...
			if (string.IsNullOrEmpty(result) || !UtilHelper.IsIP(result))
				return "127.0.0.1";
			return result;
		}
